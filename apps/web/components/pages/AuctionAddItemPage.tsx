...
const AddAuctionItemPage = () => {
  return (
    <form className="relative mx-auto w-full overflow-hidden bg-white">
      {/* 제목 */}
      <section
      ...
      <section className="left-0 flex w-full flex-col gap-7 px-3.5 py-2">
        ...
        <div className="bottom-8 left-[15px] flex h-12 w-full items-center justify-center rounded-md bg-indigo-500 px-6 py-2">
          <button
            type="submit"
            className="bottom-8 left-[15px] flex h-12 w-full items-center justify-center rounded-md bg-indigo-500 px-6 py-2 font-bold text-white"
          >
            경매 등록하기
          </button>
        </div>
