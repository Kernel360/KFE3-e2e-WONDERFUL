...
import AttacedImagesThumbnail from '@/components/auction-form/attach-images-thumbnail';
import AttachImagesInput from '@/components/auction-form/attach-images-input';
